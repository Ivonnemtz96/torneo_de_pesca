...
<head>
<meta charset="utf-8">
<title>4to Torneo de pesca deportivo</title>
<!-- Stylesheets -->
            ...
            <div class="outer-container">
				<div class="inner clearfix">
                    <div class="top-left clearfix">
                        ...
                        <div class="info">
                            <ul class="clearfix">
                                <li class="phone"><a href="tel:(624)1513281"><span class="icon fa fa-phone-alt"></span> (624) 151 3281</a></li>
                                <li class="email"><a href="mailto:info@torneomisiondemagdalena.com"><span class="icon fa fa-envelope"></span>info@torneomisiondemagdalena.com</a></li>
                            </ul>
                        </div>
        ...
        <div class="header-upper">
            <div class="outer-container">
                <div class="inner clearfix">
                    <!--Logo-->
                    <div class="logo-box">
                        <div class="logo"><a href="index.html" title="Torneo la mision de Magdalena"><img src="images/logo-two.png" alt="Torneo de pesca" title="Torneo la mision de Magdalena"></a></div>
                    </div>
                    <div class="nav-content clearfix">
                        <div class="nav-outer clearfix">
                            <!--Mobile Navigation Toggler-->
                            <div class="mobile-nav-toggler"><span style="color:#000;" class="icon flaticon-menu-1"></span></div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li><a href="#">Directorio de hospedaje</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                        ...
                        <div class="other-links clearfix">
                            <!--Book Btn-->
                            <div class="book-btn">
                                <a href="#inscripcion" class="theme-btn btn-style-one"><div class="btn-title">Inscríbete</div></a>
                            </div>
                            <!--Social Links-->
                            <div class="social-links social-links-one">
                                <ul class="clearfix">
                                    <li><a target="_blank" href="https://www.facebook.com/lamisiondemagdalena/"><span class="fab fa-facebook-f"></span></a></li>
...
<!--Page Title-->
    ...
    <section class="welcome-section">
        <div class="auto-container">
            <div class="title-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                <h2>Gracias por registrar tu equipo <br><strong><?php echo $equipo; ?></strong></h2>
                <div class="text">Hemos recibido tu registro con éxito, por favor <b>realiza el pago de tu inscripción</b>. <br>Aquí tienes la información para los diferentes métodos de pago.</div>
            </div>
            <div class="row">
                <div class="col-md-6 mt-80">
                    <div class="title-box wow fadeInUp" data-wow-delay="800ms" data-wow-duration="1500ms">
                        ...
                        <p><b>Tarjeta de débito: </b>4555 1130 0339 7132<br><i>(Déposito en Oxxo)</i></p>
                        <h5 class="mt-50">Envía tu comprobante por messenger a <a target="_blank" href="https://www.facebook.com/Torneo-la-Misi%C3%B3n-de-Magdalena-101978351223084/">Nuestra página de Facebook</a> con el nombre de tu equipo, también puedes hacerlo por <a href="https://api.whatsapp.com/send?phone=526241513281">WhatsApp (624) 151 3281</a> con <b>Abraham Torres</b></h5>
                    </div>
                </div>
                    ...
                    <div class="price-block">
                        <div class="inner-box">
                            <div class="plan-header">
                                ...
                                <div class="subtitle">Día de inscripción 29 de Octubre, día de pezca 30 de Octubre</div>
                                <div class="price">
                                ...
                                <div class="subtitle"><i><b>Despúes del 1ro de Octubre el costo será de $5,000</b></i></div>
                            </div>
                    ...
                    if (($embarcacion=="")) {
                        ...
                        <div class="col-md-12 mt-80">
                            <div class="title-box wow fadeInUp" data-wow-delay="800ms" data-wow-duration="1500ms">
                                ...
                                <p>Llámanos al: (624) 151 3281 o escríbenos por WhatsApp con <b>Abraham Torres</b></p>
                            </div>
                        </div>
    ...
    <footer class="main-footer">
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="inner clearfix">
                    <div class="text-center">4to Torneo de pesca deportivo - La Misión de Magdalena 2020 - Sitio web creado por <a target="_blank" href="https:bananagroup.mx">Banana Group</a></div>
